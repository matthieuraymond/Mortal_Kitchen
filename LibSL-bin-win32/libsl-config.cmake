...
########################################
	SET(LIBSL_LIBRARIES         "${LIBSL_LIBRARY_DIR}/libLibSL.a;${LIBSL_LIBRARY_DIR}/libjpeg.a;${LIBSL_LIBRARY_DIR}/libpng.a;${LIBSL_LIBRARY_DIR}/libzlib.a;${LIBSL_LIBRARY_DIR}/libloki.a;${LIBSL_LIBRARY_DIR}/lib3ds.a;${LIBSL_LIBRARY_DIR}/libtinyxml.a;${LIBSL_LIBRARY_DIR}/libhashlibpp.a")
...
IF (NOT TARGET LibSL_gl)
  ADD_LIBRARY(LibSL_gl STATIC IMPORTED)
  SET_PROPERTY(TARGET LibSL_gl PROPERTY IMPORTED_LOCATION
	${LIBSL_LIBRARY_DIR}/libLibSL_gl.a)
