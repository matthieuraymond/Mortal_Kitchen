...
typedef void (APIENTRYP PFNGLUXMULTIDRAWARRAYSINDIRECTAMDPROC) (GLenum mode, const GLvoid *indirect, GLsizei primcount, GLsizei stride);
#endif
#ifndef __GLUX__GLFCT_glMultiDrawElementsIndirectAMD
typedef void (APIENTRYP PFNGLUXMULTIDRAWELEMENTSINDIRECTAMDPROC) (GLenum mode, GLenum type, const GLvoid *indirect, GLsizei primcount, GLsizei stride);
#endif
// --------------------------------------------------------
