...
typedef void (APIENTRYP PFNGLUXGETQUERYOBJECTI64VEXTPROC) (GLuint id, GLenum pname, GLint64EXT *params);
#endif
#ifndef __GLUX__GLFCT_glGetQueryObjectui64vEXT
typedef void (APIENTRYP PFNGLUXGETQUERYOBJECTUI64VEXTPROC) (GLuint id, GLenum pname, GLuint64EXT *params);
#endif
// --------------------------------------------------------
