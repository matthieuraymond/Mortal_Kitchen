...
addanim(player ..'walk'..separator..'left.png',250,100)
addanim(player ..'walk'..separator..'right.png',250,100)
addanim(player ..'fight'..separator..'right.png',300,100)
addanim(player ..'fight'..separator..'left.png',300,100)
