...
-- load tile map
tilemap('map1.png',32,32)

-- add enemies

function init_entities() 
	set_entity("enemy", "ketchup.lua", 0.9, 0)
	...
	set_entity("enemy", "oignon.lua",2.8,100)
	...
	set_entity("enemy", "oignon.lua", 5.9, 100)
	set_entity("boss", "maxipain.lua", 8.5* 1280, 150)
end
