...
typedef void (APIENTRYP PFNGLUXDRAWELEMENTSBASEVERTEXPROC) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex);
#endif
#ifndef __GLUX__GLFCT_glDrawRangeElementsBaseVertex
typedef void (APIENTRYP PFNGLUXDRAWRANGEELEMENTSBASEVERTEXPROC) (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex);
#endif
#ifndef __GLUX__GLFCT_glDrawElementsInstancedBaseVertex
typedef void (APIENTRYP PFNGLUXDRAWELEMENTSINSTANCEDBASEVERTEXPROC) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei instancecount, GLint basevertex);
#endif
#ifndef __GLUX__GLFCT_glMultiDrawElementsBaseVertex
typedef void (APIENTRYP PFNGLUXMULTIDRAWELEMENTSBASEVERTEXPROC) (GLenum mode, const GLsizei *count, GLenum type, const GLvoid* const *indices, GLsizei drawcount, const GLint *basevertex);
#endif
// --------------------------------------------------------
